...
<div class="mb-3 d-flex justify-content-center">
  <div class="w-50">
    ...
    <input type="text" name="username" class="form-control my-3" value="<?= $_SESSION['auth']['username'] ?>" placeholder="Your Name" />
    <span class="text-danger"><?= $_SESSION['errors']['name_error'] ?? null ?></span>
    <br />
    <label for="">Your Email</label>
    <input type="email" name="email" class="form-control my-3" value="<?= $_SESSION['auth']['email'] ?>" placeholder="Email" />
